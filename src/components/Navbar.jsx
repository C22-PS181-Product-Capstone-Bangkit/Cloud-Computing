      ...
      <nav className="md:flex md:items-center">
        ...
        <div className="ml-auto relative md:mr-5">
          <ul className={`md:flex ${open ? "block" : "hidden"}`}>
            <li>
              <HashLink className="hover:text-cyan-410" to="#home">
            ...
            <li>
              <HashLink className="hover:text-cyan-410" to="#about">
                <p className="md:p-3 md:mx-1 md:ml-0 md:mb-0 font-semibold py-2 pl-2 ml-5 mb-4">
                  Tentang
                </p>{" "}
              </HashLink>
            ...
            <li>
              <HashLink className="hover:text-cyan-410" to="#feature">
                <p className="md:p-3 md:mx-1 md:ml-0 md:mb-0 font-semibold py-2 pl-2 ml-5 mb-4">
                  Fitur
                </p>
              </HashLink>
            ...
            <li>
              <HashLink className="hover:text-cyan-410" to="#demo">
                <p className="md:p-3 md:mx-1 md:ml-0 md:mb-0 font-semibold py-2 pl-2 ml-5 mb-4">
                  Demo
                </p>
              </HashLink>
